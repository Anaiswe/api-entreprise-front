            ...
            <div>
              ...
              <ul>
                {item.siege.liste_idcc.map((idcc, idccIndex) => {
                  ...
                  <span>
                     <a href = {`https://www.legifrance.gouv.fr/search/acco?tab_selection=acco&searchField=ALL&query=*&searchProximity=&searchType=ALL&isAdvancedResult=&isAdvancedResult=&dateDiffusion=&dateSignature=&siret=${siret}&typePagination=DEFAULT&sortValue=PERTINENCE&pageSize=10&page=1&tab_selection=acco#acco`}
                     target = "_blank"
                     rel = "noopener noreferrer"
                     >
