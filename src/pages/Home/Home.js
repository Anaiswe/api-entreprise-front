...
const [limitMatchingEtablissments, setLimitMatchingEtablissments] = useState (1);
...
console.log("thiss filtersObjDJSQHS", filterObject(search))
  ...
  fetchDataApi();
},[search, departement, postalCode, isIdcc, page, perPage, limitMatchingEtablissments]);
console.log("THIS I RECEIVED", search, departement, postalCode, isIdcc, page, perPage, limitMatchingEtablissments)
      ...
      <div className="home">
        ...
        <div className = "home-text">
          ...
          isIdcc : {isIdcc}
            ...
            <span>
          limitMatchingEtablissments : {limitMatchingEtablissments}
            </span>
        </div>
